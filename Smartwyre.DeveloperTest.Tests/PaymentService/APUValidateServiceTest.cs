...
public class APUValidateServiceTest
{
    ...
    [Theory]
    [InlineData("test-identifier-product", "test-identifier-rebate", SupportedIncentiveType.AmountPerUom, 10, 2, 2, true)] // Success case
    [InlineData("test-identifier-product", "test-identifier-rebate", SupportedIncentiveType.FixedCashAmount, 10, 2, 2, false)] // Unsupported type
    [InlineData("test-identifier-product", "test-identifier-rebate", SupportedIncentiveType.AmountPerUom, 10, 0, 2, false)] // Zero amount
    [InlineData("test-identifier-product", "test-identifier-rebate", SupportedIncentiveType.AmountPerUom, 10, 2, 0, false)] // Zero volume
    [InlineData(null, "test-identifier-rebate", SupportedIncentiveType.AmountPerUom, 10, 2, 2, false)] // Null product
    [InlineData("test-identifier-product", null, SupportedIncentiveType.AmountPerUom, 10, 2, 2, false)] // Null rebate
